...
export class QuoteHttpFeed {
  ...
  async fetchBasicData(codes: string[]): Promise<Map<string, any>> {
    try {
  ...
  async fetchFullData(codes: string[], force?: boolean): Promise<Map<string, any>> {
  ...
  async fetchFromTencent(codes: string[]): Promise<Map<string, any>> {
  ...
  async fetchFromSina(codes: string[]): Promise<Map<string, any>> {
  ...
  async fetchFromEastMoney(codes: string[], force?: boolean): Promise<Map<string, any>> {
