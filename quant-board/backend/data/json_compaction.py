...
DEFAULT_JSON_TABLES = {
    ...
    "snapshot_stock_rows": ["depth10_json", "themes_json", "theme_risk_flags_json"],
    "snapshot_sector_rows": ["metadata_json", "theme_quality_flags_json"],
    "golden_ranktrend_cases": ["input_json", "expected_json"],
    "backtest_runs": ["request_json", "result_json"],
    "backtest_trades": ["fill_detail_json"],
    "backtest_signals": ["reasons_json", "risk_flags_json", "theme_risk_flags_json", "theme_reasons_json"],
