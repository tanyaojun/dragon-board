...
def _migrate_snapshot_db(eng: "Engine") -> None:
    ...
    migrations = [
        ...
        ("snapshot_stock_rows", "jump_direction", "VARCHAR(32)"),
        ("snapshot_stock_rows", "jump_confidence", "FLOAT"),
        ("snapshot_stock_rows", "macd_cross", "VARCHAR(32)"),
        ("snapshot_stock_rows", "resonance_intensity", "FLOAT"),
